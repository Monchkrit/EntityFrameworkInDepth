...
namespace DbFirst
{
    ...
    public partial class PlutoDbContext : DbContext
    {
        ...
        public virtual IQueryable<CourseSection> GetAuthorCourses(Nullable<int> authorID)
        {
            var authorIDParameter = authorID.HasValue ?
                new ObjectParameter("AuthorID", authorID) :
                new ObjectParameter("AuthorID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<CourseSection>("[PlutoDbContext].[GetAuthorCourses](@AuthorID)", authorIDParameter);
        }
